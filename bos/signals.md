...
3. Создайте в /home/user файл `file.txt` и напишите в него свою фамилию. Сохраните файл.
...
6. Измените содержимое файла, написав в него номер своей группы. 
...
_Кстати_, в соответствии с таблицей команду `kill -2 pid` можно заменить на сочетание клавиш `Ctrl+C` в окне с запущенной программой. Попробуйте самостоятельно, после чего **сделайте скриншоты**, на которых видно вывод программы (фамилия, номер группы), а также видно, что сигнал был послан нажатием клавиш Ctrl+C (своеобразные символы в терминале)
